...
pg_dump --dbname=postgresql://postgres:000DHPdhpDHP000@192.168.55.250:5432/postgres > backups/dev-env/${backup_date}-${backup_hour}/backup-dbecommerce-${backup_date}-${backup_hour}
